...
run(function()
	...
	if not canDebug then
		local cheatenginelib = loadstring(downloadFile('SkyVape/libraries/cheatenginelib.lua'), 'cheatenginelib')(vape, vapeEvents, entitylib)
		require = function(v) 
...
run(function()
	...
	local packages = httpService:JSONDecode(downloadFile('SkyVape/profiles/packages.json'))	
...
run(function()
    ...
    vape.Components.HotbarList = function(optionsettings, children, api)
        ...
        textbuttonicon.Image = getcustomasset('SkyVape/assets/new/add.png')
            ...
            local mounted = bedwars.Roact.mount(create('BillboardGui', {
                ...
                create('Frame', {
                    ...
                    create('ImageLabel', {
                        ...
                        BackgroundTransparency = 1,
                        Image = getcustomasset('SkyVape/assets/new/blur.png'),
